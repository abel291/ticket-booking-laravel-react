...
const Speaker = ({ speaker }) => {
    return (
        <Layout title="Términos de servicio">
            <BannerHero title="Perfil del Orador" />

            <div className="py-section container max-w-7xl">
                <div className="grid grid-cols-6 gap-10">
                    <div className="col-span-2">
                        ...
                        />
                        <a href={speaker.website} target="_blank" className="text-xl block font-semibold text-center mt-6">
                            {speaker.website}
                        </a>
                    </div>
                    <div className="col-span-4">
                        <div>
                            <h2 className="text-4xl font-bold uppercase">{speaker.name}</h2>
                            <p className="mt-2 font-medium">{speaker.position}</p>
                        </div>
                        <div className="border-y mt-8 py-4 px-10">


                            <div className="flex items-stretch divide-x">
                                <div className="w-1/2">
                                    <div className="flex items-center gap-x-3">
                                        <EnvelopeOpenIcon className="h-14" />
                                        <div className="flex flex-col justify-center">
                                            <p className="text-sm "> Contactenos:</p>
                                            <p className="font-medium text-primary-500 mt-1">{speaker.email}</p>
                                        </div>
                                    </div>
                                </div>

                                <div className="w-1/2 ">
                                    <div className="h-full flex items-center gap-x-3 justify-end">
                                        <a href={speaker.instagram}>
                                            <div className="bg-primary-500 p-2 rounded-full h-8 w-8">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold uppercase mt-10">Sobre Mi</h2>
                            <p className="mt-4  leading-7">{speaker.description}</p>
                        </div>
                    </div>
                </div>
            </div>
