                        ...
                        <div className="mt-4  ">
                            ...
                            <div className="mt-8 flex flex-col gap-5 text-primary-500 ">
                                <div className="flex items-center gap-3 text-lg ">
                                    {/* <FaHandshake className=" h-12 w-12 rounded-full border border-dark-blue-700 py-1.5 px-2 text-primary-400" /> */}
                                    <p>Honestidad y Justicia</p>
                                </div>

                                <div className="flex items-center gap-3 text-lg ">
                                    {/* <FaCheck className=" h-12 w-12 rounded-full border border-dark-blue-700 py-1.5 px-2 text-primary-400" /> */}
                                    <p>Claridad y Transparencia</p>
                                </div>

                                <div className="flex items-center gap-3 text-lg ">
                                    {/* <FaUsers className=" h-12 w-12 rounded-full border border-dark-blue-700 py-1.5 px-2 text-primary-400" /> */}
