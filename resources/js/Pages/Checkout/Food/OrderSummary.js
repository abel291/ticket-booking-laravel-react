...
const OrderSummary = () => {
    return (
        <div className="divide-y divide-dashed divide-dark-blue-400 border border-dark-blue-500 bg-dark-blue-700 p-7">
            <div className="text-center">
                <h5 className="font-medium uppercase">Resumen de pedido</h5>
            </div>
            <div className="mt-7 space-y-4 py-6 ">
                <div>
            ...
            <div className="py-6">
                <div className="text-center">
                    ...
                    <Button className="mt-5">Proceder a pagar</Button>
                </div>
            </div>
        </div>
    );
