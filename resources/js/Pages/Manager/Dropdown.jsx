	...
	return (
		<Menu.Item>
			<Link
				...
				method={method}
				as={as}
				className="block w-full px-4 py-2.5 text-left  leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-primary-700 transition duration-150 ease-in-out"
			>
				{children}
			</Link>
		</Menu.Item>
