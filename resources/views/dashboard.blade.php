    ...
    <div class="max-w-7xl mx-auto ">
        <div class="bg-white grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="p-6 border-t border-gray-200">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        Laravel  is built with Tailwind, an amazing utility first CSS framework that doesn't
            ...
            <div class="p-6 border-t border-gray-200 md:border-l">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        Authentication and registration views are included with Laravel , as well as support
